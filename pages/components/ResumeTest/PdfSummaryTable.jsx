...
import { detectSector, generateResumeJSON, generateTailoredResumeJSON, generateTenderResponse, validateTenderResponseFormat } from "@/pages/api/geminiApi";
...
import ResumeTemplateTable from "../ResumeTest/ResumeTemplateTable";
import TenderResponseWrapper from "../TenderResponse/TenderResponseWrapper";

const PdfSummaryTable = ({ pdfText, fileName, profilePicture, profilePicturePreview }) => {
...
if (showResumeTemplate && resumeData) {
  ...
  return (
    <div>
      ...
      <ResumeTemplateTable resumeData={resumeData} onBackToSummary={handleBackToSummary} />
    </div>
  );
}
...
export default PdfSummaryTable;
