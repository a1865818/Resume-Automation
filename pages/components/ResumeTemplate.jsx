...
// const ResumeTemplate = ({ resumeData, onBackToSummary }) => {
...
//     // Measure after component mounts and DOM is ready
...
//         const contentRect = actualContent.getBoundingClientRect();
//         // const widthMm = Math.round((contentRect.width * 25.4) / 96);
//         // // Reduce height by 5-10mm to account for PDF rendering differences
//         // const heightMm = Math.round(((contentRect.height * 25.4) / 96) - 8);
...
//   return (
//     <div style={{ minHeight: '100vh', backgroundColor: '#f3f4f6', paddingTop: '2rem' }}>
...
//       {/* Resume Content - EXACT SAME STYLING AS ORIGINAL */}
//       <div id="resume-content" style={{ display: 'flex', justifyContent: 'center', backgroundColor: '#e5e7eb' }}>
//         <div style={{ width: '100%', backgroundColor: 'white', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)' }}>
