...
const SavedSummaries = () => {
  ...
  const viewAsPdf = (summary) => {
    ...
    // Open PDF in a new tab using our PDF generation API
    window.open(`/api/viewAsPdf?fileName=${encodeURIComponent(fileName)}`, '_blank');
  };
                  ...
                  <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                    <div className="mb-4 md:mb-0 md:mr-4 flex-grow">
                      ...
                      {summary.industries && summary.industries.length > 0 && (
                        <div className="mt-1">
                          <span className="text-xs text-gray-500">Industries: </span>
                          <span className="text-xs text-gray-700">{Array.isArray(summary.industries) ? summary.industries.join(', ') : summary.industries}</span>
                        </div>
                      )}
