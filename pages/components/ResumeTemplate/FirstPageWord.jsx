const FirstPageWord = ({ resumeData, mainExperience, scaleFactor, wordPageWidth, wordPageHeight }) => {
  ...
  const scaledProfileWidth = Math.round(200 * scaleFactor);
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td style={{
                                        ...
                                        padding: '0',
                                        border: 'none'
                                      }}>{resumeData.profile.clearance}</td>
                                    </tr>
                                  </tbody>
                                </table>
                              ) : (
                    ...
                    <td style={{
                      ...
                      <table style={{
                        ...
                        <tbody>
                          ...
                          {/* Skills Content Row - Takes remaining space */}
                          <tr style={{ height: '100%' }}>
                            <td style={{
                              padding: '0',
                              border: 'none',
                                      ...
                                      <tr key={index}>
                                        <td style={{
                                          ...
                                          <table style={{
                                            ...
                                            borderCollapse: 'collapse',
                                            border: 'none',
                                            marginLeft: `${Math.round(3 * scaleFactor)}px`
                                          }}>
                                            <tbody>
