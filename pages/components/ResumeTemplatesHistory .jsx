// components/ResumeTemplatesHistory.jsx
import { useEffect, useState } from "react";
import ResumeTemplate from "./ResumeTemplate";

const ResumeTemplatesHistory = () => {
  ...
  const fetchResumeTemplates = async (filterParams = {}) => {
    try {
      ...
      const response = await fetch(`/api/listResumeTemplates${queryString}`);
  ...
  const handleFilterChange = (newFilters) => {
    ...
    fetchResumeTemplates(newFilters);
  };
  ...
  const deleteTemplate = async (template) => {
    ...
    try {
      const response = await fetch("/api/deleteResumeTemplate", {
        method: "DELETE",
        headers: {
  ...
  // If showing template, render the ResumeTemplate component
    ...
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                const newFilters = { ...filters, candidateName: e.target.value };
                setFilters(newFilters);
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                const newFilters = { ...filters, profileTitle: e.target.value };
                setFilters(newFilters);
                handleFilterChange(newFilters);
              }}
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-semibold">Resume Templates History</h2>
          ...
          <div className="text-center py-8">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {Object.values(filters).some((v) => v)
                ...
                : "Generate a resume template to see it listed here."}
            </p>
          </div>
        ) : (
                  ...
                  <div className="mb-4 md:mb-0 md:mr-4 flex-grow">
                    ...
                    <div className="mt-2 grid grid-cols-2 md:grid-cols-5 gap-2 text-xs">
                      <div className="flex items-center text-gray-600">
                        ...
                        {template.qualificationsCount} Quals
                      </div>
                      <div className="flex items-center text-gray-600">
                        <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="flex items-center text-gray-600">
                        ...
                        {template.experienceCount} Jobs
                      </div>
                      <div className="flex items-center text-gray-600">
                        <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path>
                        </svg>
                        {template.achievementsCount} Achievements
                      </div>
                      ...
                      <div className="flex items-center text-gray-600">
                        ...
                        {template.refereesCount} Referees
                      </div>
                    </div>
...
export default ResumeTemplatesHistory;